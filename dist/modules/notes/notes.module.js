...
const note_schema_1 = require("../../core/schemas/note.schema");
const note_schema_2 = require("../../core/schemas/note.schema");
...
exports.NotesModule = NotesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: note_schema_1.Note.name, schema: note_schema_2.NoteSchema }]),
        ],
